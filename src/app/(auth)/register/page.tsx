          ...
          <div className="flex flex-col items-center mb-6">
            ...
            <p className="text-xs text-muted-foreground font-mono tracking-wide text-center mt-1">
              {registeredEmail
                ...
                : "Choose Google OAuth or enter analyst credentials below"}
            </p>
          </div>
          ...
          {registeredEmail ? (
            ...
            <>
              ...
              <Button
                type="button"
                variant="outline"
                className="w-full h-10 bg-background/70 hover:bg-muted/80 backdrop-blur-md text-foreground border-border rounded-xl font-medium text-xs transition-all flex items-center justify-center gap-2 cursor-pointer shadow-sm active:scale-[0.98] mb-3.5"
